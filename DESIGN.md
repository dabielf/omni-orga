...
Use tinted neutrals with one restrained mint accent.
...
Use Outfit for all interface text, with system sans-serif as the fallback. Use weight and size for hierarchy. Keep body text at 70 characters per line or less.
